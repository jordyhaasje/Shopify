...
- Current real write tools are `page.create.execute`, `product.create.execute`, minimal basic-field, explicit-variant-price, explicit-variant-create, explicit-option-create, explicit-option-rename, explicit-option-value-rename, or explicit-option-value-add `product.update.execute`, and custom explicit-product `collection.create.execute`.
