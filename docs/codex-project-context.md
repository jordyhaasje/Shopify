...
- Current real write tools are `page.create.execute`, `product.create.execute`, minimal basic-field, explicit-variant-price, or explicit-variant-create `product.update.execute`, and custom explicit-product `collection.create.execute`.
