...
- Current real write tools are `page.create.execute`, `product.create.execute`, minimal basic-field or explicit-variant-price `product.update.execute`, and custom explicit-product `collection.create.execute`.
