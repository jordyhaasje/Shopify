...
- Current real write tools are `page.create.execute`, `product.create.execute`, minimal basic-field, explicit-variant-price, explicit-variant-create, or explicit-option-create `product.update.execute`, and custom explicit-product `collection.create.execute`.
