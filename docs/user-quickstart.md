...
- Product update execute beyond basic fields, explicit variant price updates, explicit variant creation, explicit option creation, explicit option rename, and explicit option value rename.
- Production-store write automation.
- Rule-based/smart collection create, collection publishing, refund, tracking, customer, bulk, theme, option value add/delete, option reorder/delete, media, inventory, metafields, publications, translations, and other advanced execute implementations.
