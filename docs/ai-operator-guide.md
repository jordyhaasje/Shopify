...
- `product.update.execute` for basic product fields, explicit variant price updates, explicit variant creation, explicit option creation, explicit option delete, explicit option rename, explicit option value rename, explicit option value add, or explicit option value delete only
