...
- `product.update.execute` for basic product fields, explicit variant price updates, explicit variant creation, explicit option creation, explicit option rename, explicit option value rename, or explicit option value add only
