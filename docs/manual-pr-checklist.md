...
- Confirm write-mode warnings name `page.create.execute`, `product.create.execute`, `product.update.execute`, and `collection.create.execute` as the only implemented execute tools, with all other execute tools remaining fail-closed placeholders.
