...
- Confirm write-mode warnings name `page.create.execute` and `product.create.execute` as the only implemented execute tools, with all other execute tools remaining fail-closed placeholders.
