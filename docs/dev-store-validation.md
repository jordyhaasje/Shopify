...
- Confirm any deliberate write test is limited to `page.create.execute`, `product.create.execute`, basic-field, explicit-variant-price, explicit-variant-create, explicit-option-create, or explicit-option-rename `product.update.execute`, or custom explicit-product `collection.create.execute` in a development store.
...
- Keep read-only mode enabled except for explicit reviewed `page.create.execute`, `product.create.execute`, basic-field, explicit-variant-price, explicit-variant-create, explicit-option-create, or explicit-option-rename `product.update.execute`, or custom explicit-product `collection.create.execute` development-store tests.
